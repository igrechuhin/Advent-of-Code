...
private func getDay12Input() -> String {
    //"""
    //???.### 1,1,3
    //.??..??...?##. 1,1,3
    //?#?#?#?#?#?#?#? 1,3,1,6
...
private let operational = Set<Character>([".", "?"])
private let broken = Set<Character>(["#", "?"])
...
public func solveDay12Puzzle1() -> Int {
    getDay12Input()
...
public func solveDay12Puzzle2() -> Int {
    getDay12Input()
        .components(separatedBy: .newlines)
        .filter { !$0.isEmpty }
