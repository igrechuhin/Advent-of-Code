...
private func getDay21Input() -> String {
    //"""
    //...........
    //.....###.#.
    //.###.##..#.
...
private func fillGrid(_ grid: [[Character]], start: Point2D, steps: Int) -> [Int] {
    var counts = [1]
    var count1 = 0
    var count2 = 1
...
public func solveDay21Puzzle1() -> Int {
...
public func solveDay21Puzzle2() -> Int {
    let input = getDay21Input().as2DArray
    let start = input.getFirstPositionOfCharacter("S")!
