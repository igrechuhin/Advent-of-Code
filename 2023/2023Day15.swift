...
extension AoC2023 {
    private static func getDay15Input() -> String {
        //"""
        //rn=1,cm-,qp=3,cm=2,qp-,pc=4,ot=9,ab=5,pc-,pc=6,ot=7
        //"""
        
        getInput(fileName: "Day15Input")
    }
    ...
    static func solveDay15Puzzle1() -> Int {
        getDay15Input()
    ...
    static func solveDay15Puzzle2() -> Int {
        let input = getDay15Input()
            .components(separatedBy: ",")
            .map { $0.trimmingCharacters(in: .newlines) }
            .filter { !$0.isEmpty }
        ...
        for step in input {
            ...
            let boxIndex = stepLabel.adventHash
            
            var box = boxes[boxIndex]
            let lensIndex = box.firstIndex { $0.label == stepLabel }
...
private extension String {
    static let operations: Set<Character> = ["=", "-"]
    
    var label: String {
        String(
            prefix(upTo: firstIndex(where: String.operations.contains)!)
        )
    }
