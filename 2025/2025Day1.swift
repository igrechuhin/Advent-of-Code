...
extension AoC2025 {
    private static func getPuzzleInput(mode: AoCMode) -> [Direction] {
    ...
    private enum Direction {
        ...
        init?(_ raw: String) {
            guard let count = Int(String(raw.filter(\.isNumber))) else { return nil }
